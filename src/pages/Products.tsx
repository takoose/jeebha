          ...
          {filteredProducts.map((product) => (
            <div key={product.id} className="dashboard-card group hover:border-yellow transition-all">
              <div className="h-40 bg-slate-100 relative overflow-hidden">
                <img 
                  src={product.image || (product.category?.toLowerCase() === 'cement' ? '/img/product_cement.jpg' : product.category?.toLowerCase() === 'steel' ? '/img/product_steel.jpg' : '/img/materials_showcase.jpg')} 
                  alt={product.name} 
