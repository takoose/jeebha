            ...
            <div className="space-y-3 overflow-y-auto flex-1 pr-2 custom-scrollbar">
              {activeOrders.length === 0 ? (
                <div className="h-full flex flex-col items-center justify-center p-8 bg-slate-50/50 rounded-3xl border border-dashed border-slate-200 relative overflow-hidden group">
                  <img src="/src/img/tracking_illustration.jpg" className="absolute inset-0 w-full h-full object-cover opacity-10 group-hover:opacity-20 transition-opacity duration-700" alt="Tracking" />
